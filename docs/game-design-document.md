...
**Cap raised to 200 and castle HP raised from 40 to 100 (2026-09-25),** in response to the two tests below; not yet re-tested. The numbers in those tests (their "lost at the cap" totals, the 40 HP castle, the ~90s wins) were measured at a cap of 100 and 40 HP, so re-run them before trusting any comparison.
